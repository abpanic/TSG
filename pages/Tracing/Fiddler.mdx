---
title: Capture a Fiddler trace for debugging
description: Capture network information from fiddler.
ms.date: 05/01/2023
ms.topic: how-to
---
* If you don't have Fiddler Cap, please install it at https://www.telerik.com/download/fiddler

# Set up Fiddler to capture secure HTTP addresses
Before you can begin capturing web requests, you must first enable Fiddler to capture secure HTTP addresses (https://) on your device.
...
![Select yes in the root certificate dialog box](./media/fiddler/fiddler-root-certificate.png)
...
On your keyboard, press Ctrl + X to clear all traces from Fiddler's traffic pane

![Clearing Fiddler Pane](./media/fiddler/clear-fiddler-pane.png)
...
![Image showing how to reset all certificates and return your system to its original configuration](./media/fiddler/reset-all-certificates.png)
