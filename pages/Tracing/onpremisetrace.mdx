...
For Advanced Configuration, to capture CRM traces along with stack trace is as follows:
...
A simple powershell script to capture traces :
...
#feedback to: github.com/abpanic
