...
Refer: https://www.ibm.com/support/pages/exporting-windows-event-logs-event-viewer
...
Expanding Windows Logs:
Filtering logs:
https://superuser.com/questions/1342618/event-viewer-filter-by-source-disabled
Saving logs:
...
Depending on the specific issue you're troubleshooting, you might need to collect logs from different sources in addition to the Event Viewer. 