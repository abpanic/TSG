---
title: Event Viewer
description: Accessing logged events from Event Viewer.
ms.date: 05/01/2023
ms.topic: how-to
---
# Collecting Event Viewer Logs

This document outlines the steps for collecting Event Viewer logs. These logs can provide valuable insights for troubleshooting and resolving various problems.
...
**Application**: For application-specific events, for D365 CE related entries, look for D365 CE or Dynamics CRM.
